...
#ifndef NVTX_DISABLE
  constexpr std::array kColors{nvtx3::color{0xff00ff00}, nvtx3::color{0xff0000ff},
                               nvtx3::color{0xffffff00}, nvtx3::color{0xffff00ff},
                               nvtx3::color{0xff00ffff}, nvtx3::color{0xffff0000},
                               nvtx3::color{0xffffffff}};
...
#define NVTX3_SCOPED_RANGE(range)                                                                  \
  ::nvtx3::scoped_range range##_range(::tensorrt_llm::common::nvtx::nextColor(), #range)
